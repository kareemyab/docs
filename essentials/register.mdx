...
<Steps>
  <Step title="Create Wallet (if needed)">
    ...
    <Note>**One-time only**: Skip this step if you already have a wallet. Each user only needs one Crossmint wallet for all registrations.</Note>
