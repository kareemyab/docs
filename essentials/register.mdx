...
<Card title="Success Responses">

<Tabs>
  <Tab title="Crossmint (202)">
    <ResponseField name="message" type="string">
      Success confirmation message for Crossmint wallet transactions
      
      Example: `"✅ Accepted! Your file has been submitted and is being processed by Crossmint."`
    </ResponseField>
...
<Tabs>
  ...
  <Tab title="Duplicate Registration (409)">
    <ResponseField name="error" type="boolean">
    ...
    <ResponseField name="message" type="string">
      ...
      Example: `"🚫 FILE ALREADY REGISTERED 🚫"`
    </ResponseField>
...
<Card title="Raw Response Examples">
