...
```json User ID Relation Already Exists (409)
{
  "message": "User ID already linked to an existing wallet."
}
```

```json Wallet Relation Already Exists (409)
{
  "message": "Wallet address already linked to an existing User ID"
}
```
