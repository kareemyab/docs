...
The create-wallet command allows you to create a new managed wallet for a user in the Trust Engine system. Each user should only run this command **once** and reuse the generated wallet for all future operations.
