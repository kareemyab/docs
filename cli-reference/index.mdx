...
<CardGroup cols={2}>
  ...
  <Card title="verify-identity" icon="id-card" href="/cli-reference/verify-identity">
    Initiate identity verification using Self.xyz
  </Card>
  <Card title="check-identity" icon="user-check" href="/cli-reference/check-identity">
    Check the status of identity verification
  </Card>
