...
<ResponseField name="registrations" type="Array<object>">
  ...
  <Expandable>
    ...
    <ResponseField name="validationStatus" type="string">
      Current validation status ("Verified", "Pending", or "Rejected").
    </ResponseField>
...
<ResponseField name="details" type="object">
  ...
  <Expandable>
    ...
    <ResponseField name="validatorPDA" type="string">
      The Program Derived Address for the validator.
    </ResponseField>
    <ResponseField name="stakedAmount" type="number">
      The amount staked by the validator.
    </ResponseField>
    ...
    <ResponseField name="honestVotes" type="number">
      Number of honest votes cast by the validator.
    </ResponseField>
    <ResponseField name="dishonestVotes" type="number">
      Number of dishonest votes cast by the validator.
    </ResponseField>
    <ResponseField name="accuracyPercentage" type="number">
      The validator's accuracy percentage.
    </ResponseField>
    <ResponseField name="lastActiveTime" type="number">
      Unix timestamp of the validator's last activity.
    </ResponseField>
    <ResponseField name="lastActiveDate" type="string">
      ISO timestamp of the validator's last activity.
    </ResponseField>
  </Expandable>
</ResponseField>
